...
{
    /// <summary>
    ///     Generates a set of points within a specified range 
    /// </summary>
    abstract public class PointGenerator : GenerationAlgorithm
    {
        [SerializeField]
        ...
        public abstract void Setup(Vector2[] sourcePoints);
