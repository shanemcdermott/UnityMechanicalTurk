...
namespace Framework.Util
{
    ...
    public class CameraViewObject : MonoBehaviour
    {
        ...
        /// </summary>
        public CameraViewObject nextView;
        ...
        {
            for(CameraViewObject next = nextView; next != null; next = next.nextView)
            {
        ...
        /// </returns>
        public CameraViewObject GetLast()
        {
            CameraViewObject last = nextView;
            for (CameraViewObject next = nextView; next != null; next = next.nextView)
            {
